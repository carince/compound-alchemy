                        ...
                        >
                            <ol className="list-decimal list-inside space-y-3">
                                <li>
                                    ...
                                    <Image src="/1/1-1.png" priority width={200} height={200} alt="Sodium and Chlorine" className="border border-base-300 rounded-md w-full max-w-60 p-1 my-2" />
                                </li>
                                <li>
                                    ...
                                    <Image src="/1/1-2.png" width={200} height={200} alt="Sodium and Chlorine" className="border border-base-300 rounded-md w-full max-w-60 p-1 my-2" />
                                </li>
                                <li>
                                    ...
                                    <Image src="/1/1-3.png" width={200} height={200} alt="Sodium and Chlorine" className="border border-base-300 rounded-md w-full max-w-60 p-1 my-2" />
                                </li>
                                <li>
                                    ...
                                    <Image src="/1/1-4.png" width={200} height={200} alt="Sodium and Chlorine" className="border border-base-300 rounded-md w-full max-w-60 p-1 my-2" />
                                </li>
                            </ol>
                        </motion.div>
